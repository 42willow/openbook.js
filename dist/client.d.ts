...
import { Author, AuthorWorksResponse, AuthorWorksQuery } from "./schemes/author";
...
export declare class OpenLibraryClient {
    ...
    getAuthorWorks(id: string, { limit, offset }?: AuthorWorksQuery): Promise<AuthorWorksResponse>;
